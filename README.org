...
- [[#copy-dmscripts-config-and-set-dmbrowser-to-qutebrowser][Copy dmscripts config and set DMBROWSER to 'qutebrowser']]
...
* Copy dmscripts config and set DMBROWSER to 'qutebrowser'
#+begin_src bash
