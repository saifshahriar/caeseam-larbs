...
- [[#note-to-dtos-gui ][Small note to kdialog version of DTOS]]
...
* Small note to kdialog version of DTOS

This version is still WIP (work in progress) and it still needs some care. It is essentialy a classic DTOS w/ GUI dialogs
...
+ Pacman will ask you if you want to replace libxft with libxft-bgra.
+ Pacman may ask you about other conflicting packages as well.
+ Doom Emacs will ask about creating an envar file, and...
+ Doom will also ask about installing all-the-icons fonts.

You must answer =YES (y)= to these questions!  Answering =NO= will cause pacman to stop installing the packages in pkglist.txt, thus leaving you with a broken installation.
