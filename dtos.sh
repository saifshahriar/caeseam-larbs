...
dtospkgs="adobe-source-code-pro-fonts adobe-source-sans-fonts alacritty aura bluez bluez-utils bash bat cups dmenu-distrotube dmscripts dtos-alacritty dtos-backgrounds dtos-bash dtos-conky dtos-fish dtos-local-bin dtos-opendoas dtos-sxiv dtos-xmobar dtos-xmonad dtos-xresources dtos-xwallpaper dtos-zsh element-desktop emacs exa fd fish git libxft-bgra lolcat lxappearance lxsession maim mpv neovim network-manager-applet opendoas otf-font-awesome pacman-contrib pandoc paru pcmanfm picom qalculate-gtk qt5ct qutebrowser ripgrep sddm shell-color-scripts shellcheck starship stack sxiv ttf-hack ttf-joypixels ttf-mononoki ttf-ms-fonts ttf-ubuntu-font-family trayer vim volumeicon xdotool xf86-video-qxl xf86-video-intel xf86-video-amdgpu xf86-video-nouveau xmonad xmonad-contrib xmobar xorg-server xorg-xkill xorg-xmessage xorg-xprop xorg-xrdb xorg-xset xorg-xsetroot xterm xwallpaper yad zathura zsh"
